    ...
    <section class="cart-section pb-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <c:choose>
                        <c:when test="${not empty restaurantGroups}">
                            <c:forEach var="group" items="${restaurantGroups}">
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-warning bg-opacity-25">
                                        <h5 class="mb-0">
                                            <i class="fa-solid fa-store me-2"></i>${group.restaurantName}
                                        </h5>
                                    </div>
                                    <div class="card-body p-0">
                                        <c:forEach var="item" items="${group.items}">
                                            <div class="border-bottom p-3 cart-item-row" data-unit-price="${item.price}">
                                                <div class="row g-0 align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-3">
                                                                <strong class="line-total" data-amount="${item.totalPrice}">₹ ${item.totalPrice}</strong>
                                                            </div>
                                    ...
                                    <div class="card-footer text-end">
                                        <strong class="restaurant-subtotal">Restaurant Subtotal: ₹ ${group.subtotal}</strong>
                                    </div>
                                </div>
                            </c:forEach>
                        </c:when>
                ...
                <div class="col-lg-4">
                    <div class="card shadow">
                        ...
                        <div class="card-body"
                             ...
                             data-delivery-per-restaurant="40"
                             data-tax-rate="0.05">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <span id="summary-delivery">₹ ${deliveryFee}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                                <span>Tax (GST)</span>
                            ...
                            <div class="d-flex justify-content-between">
                                <h5>Grand Total</h5>
                                <h4 id="summary-grand-total">₹ ${grandTotal}</h4>
                            </div>
                            <hr>
                            <div class="d-grid mb-3">
                                <a href="${pageContext.request.contextPath}/checkout" class="btn btn-warning btn-lg ${empty restaurantGroups ? 'disabled' : ''}">
