		...
		<div class="container">
			...
			<div class="d-flex flex-wrap gap-2">
				...
				<c:forEach var="category" items="${categories}">
					...
					<a
						href="${pageContext.request.contextPath}/menu?restaurantId=${restaurant.restaurantId}&category=${category}"
							...
							<div class="col-lg-4 col-md-6 mb-4">
								...
								<div class="card menu-card h-100 shadow-sm">
									...
									<img
										...
										onerror="this.src='https://via.placeholder.com/300x200/FFC107/1A1A2E?text=Food'; this.onerror=''">
