			...
			<div class="mb-4">
				...
				<div class="d-flex flex-wrap gap-2">
					...
					<a
						...
						href="${pageContext.request.contextPath}/OrderServlet?status=PLACED"
					...
					<a
						...
						href="${pageContext.request.contextPath}/OrderServlet?status=PREPARING"
					...
					<a
						...
						href="${pageContext.request.contextPath}/OrderServlet?status=OUT_FOR_DELIVERY"
					...
					<a
						...
						href="${pageContext.request.contextPath}/OrderServlet?status=DELIVERED"
					...
					<a
						...
						href="${pageContext.request.contextPath}/OrderServlet?status=CANCELLED"
								...
								<div class="mt-3">
									...
									<c:if test="${order.status == 'DELIVERED'}">
										...
										<a
											...
											href="${pageContext.request.contextPath}/OrderServlet?action=reorder&orderId=${order.orderId}"
									...
									<c:if test="${order.status == 'PLACED' || order.status == 'PREPARING'}">
										...
										<a
											...
											href="${pageContext.request.contextPath}/OrderServlet?action=cancel&orderId=${order.orderId}"
					...
					<ul class="pagination justify-content-center">
						...
						<li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
							...
							<a class="page-link"
							   ...
							   href="${pageContext.request.contextPath}/OrderServlet?page=${currentPage - 1}&status=${param.status}">
						...
						<c:forEach begin="1" end="${totalPages}" var="i">
							...
							<li class="page-item ${i == currentPage ? 'active' : ''}">
								...
								<a class="page-link"
								   ...
								   href="${pageContext.request.contextPath}/OrderServlet?page=${i}&status=${param.status}">
